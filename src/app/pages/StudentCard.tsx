...
export const StudentCard: React.FC = () => {
  ...
  if (!student) return <div className="p-8 text-center text-gray-500">Aluno não encontrado.</div>;
    ...
    <div className="max-w-6xl mx-auto px-4 py-8 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-xl font-black text-gray-900">Meu Cartão de Frequência</h1>
          <p className="text-gray-500 text-sm">Ano {new Date().getFullYear()}</p>
        </div>
      </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl px-4 py-3 flex items-start gap-3">
        ...
        <div className="text-sm text-[#003087]">
          ...
          <strong>Pontos vermelhos</strong> = datas de graduação ou novo grau marcadas pelo professor.
          O professor pode marcar datas especiais diretamente no seu cartão.
        </div>
      </div>
